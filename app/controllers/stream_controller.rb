    ...
    Net::HTTP.start(uri.host, uri.port, use_ssl: uri.scheme == "https") do |http|
      ...
      http.request(request) do |response|
        response.read_body do |chunk|
          p 'chunk...'
          self.response.stream.write chunk
        end
      end
    end
  end
